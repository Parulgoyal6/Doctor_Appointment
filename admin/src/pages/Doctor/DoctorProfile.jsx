...
const updateProfile = async() =>{
  ...
  return profileData &&  (
   ...
   {/****************Doc About ******************** */}
        ...
        <p className='text-sm tex-gray-600 max-w-[700px] mt-1'>{profileData.about}</p>
        </div>
       ...
       <div className='flex gap-2 py-2'>
        ...
        <input onChange={()=> isEdit && setProfileData(prev =>({...prev, availability: !prev.availability}))} checked={profileData.availability}  type="checkbox" name="" id="availability"/>
