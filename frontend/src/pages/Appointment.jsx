...
const Appointment = () => {
  ...
  const getAvailableSlots = async() =>{
    if (!docInfo) {
      // Make sure docInfo is fetched before continuing
      return;
    }
    setDocSlots([]);
  ...
  const bookAppointment = async () =>{
    ...
    try{
      ...
      // console.log("Booked Slots:", docInfo.slots_booked);
...
<div>
  ...
  <div className='flex flex-col sm:flex-row gap-4'>
    ...
    <div className='flex-1 border border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
